...
* `retail-store-inventoty-and-demand-forecasting-using-xgboost.ipynb`: 데이터 전처리, TimeSeriesDataSet 구축, XGBRegressor 모델 학습, 하이퍼파라미터 튜닝 및 결과 시각화 전 과정을 담은 주피터 노트북
